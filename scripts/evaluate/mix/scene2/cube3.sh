...
# 						--cfg configs/virat/mask_rcnn/mask_rcnn_attr_101.yaml \
# 						--multi-gpu-testing \
# 						--load_ckpt Outputs/virat2_mix/mask_rcnn_attr_101/baseline_Jun20-02-13-05_klab-server2_step/ckpt/model_step15999.pth \
...
# 						--cfg configs/virat/depth_mask_rcnn/depth_mask_rcnn_101.yaml \
# 						--multi-gpu-testing \
# 						--load_ckpt Outputs/virat2_mix/depth_mask_rcnn_101/baseline_Jun20-02-09-55_klab-server2_step/ckpt/model_step15999.pth \
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python tools/test_net.py --dataset virat2 \
						...
						--cfg configs/virat/depth_mask_rcnn/depth_mask_rcnn_attr_101.yaml \
						--multi-gpu-testing \
						--load_ckpt Outputs/virat2_mix/depth_mask_rcnn_attr_101/baseline_Jun20-02-17-09_cube3_step/ckpt/model_step15999.pth \
