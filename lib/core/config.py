...
# ------------------------------------------------------
__C.MODEL.CLIP_GRADIENT = False

__C.MODEL.ATTRIBUTE_ON = False

__C.COLOR = AttrDict()
__C.COLOR.NUM_CLASSES = -1
__C.COLOR.LOSS_WEIGHT = 1.0


__C.ROTATION = AttrDict()
__C.ROTATION.NUM_CLASSES = -1
__C.ROTATION.LOSS_WEIGHT = 1.0


__C.X = AttrDict()
__C.X.NUM_CLASSES = -1
__C.X.LOSS_WEIGHT = 1.0

__C.Y = AttrDict()
__C.Y.NUM_CLASSES = -1
__C.Y.LOSS_WEIGHT = 1.0


__C.DEPTH = AttrDict()
__C.DEPTH.WIDTH = -1
__C.DEPTH.HEIGHT = -1
__C.DEPTH.NUM_CLASSES = -1
__C.DEPTH.IS_ON = False
__C.DEPTH.LOSS_WEIGHT = 1.0
__C.DEPTH.SOFT_LABEL_ON = False


__C.NORMAL = AttrDict()
__C.NORMAL.WIDTH = -1
__C.NORMAL.HEIGHT = -1
__C.NORMAL.NUM_CLASSES = -1
__C.NORMAL.IS_ON = False
__C.NORMAL.LOSS_WEIGHT = 1.0
__C.NORMAL.SOFT_LABEL_ON = False
# ------------------------------------------------------
