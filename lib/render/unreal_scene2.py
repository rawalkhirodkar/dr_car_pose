...
parser.add_argument('--max_exception_retries', default=20, type=int)

#Output options
parser.add_argument('--start_idx', default=0, type=int)
parser.add_argument('--num_images', default=5, type=int)
parser.add_argument('--filename_prefix', default='UNREAL_SCENE2')
...
def add_random_objects(CLIENT, scene_struct, num_objects, args):
	...
	# X_MIN = -2160; X_MAX = 2890
	# Y_MIN = -3920.0; Y_MAX = 820
