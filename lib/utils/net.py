...
#the grad can be none, if the first batch is just of reals.
#in that case, the attribute branch is never used. This is a bug
# and the following fix is temporary.
